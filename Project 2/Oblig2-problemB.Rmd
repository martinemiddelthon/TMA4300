...
result = INLA::inla(formula = formula, family = "gaussian", data = data, control.family = list(hyper=list(prec =list(initial=0,fixed=TRUE))))

plot(result$summary.random$t$mean)
plot(result$marginals.hyperpar$`Precision for t`, xlim =c(0,9))
summary(result)
```
