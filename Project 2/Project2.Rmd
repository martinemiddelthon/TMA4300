...
In the first block, we sample $\tilde{t_1}$ from a normal distribution, as in section 4), and $\lambda_0$ and $\lambda_1$ are sampled from their full conditionals conditioned on the proposed $\tilde{t}_t$ BEGRUNNELSE JOINT = MARGINAL. This gives us the following acceptance probability $\alpha_1$:
$$
