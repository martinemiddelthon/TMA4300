...
mle
```
We get maximum likelihood estimators of $\hat{\lambda_0} = 3.46$ and $\hat{\lambda_1} = 9.33$, which are very close to the values we got for the estimators of $\lambda_0$ and $\lambda_1$ using the EM-method. 